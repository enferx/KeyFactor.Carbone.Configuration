...
{
    public class UpdateProductPropertyValidator : AbstractValidator<UpdateProductPropertyDto>, ITransientDependency
    {
        public UpdateProductPropertyValidator(IStringLocalizer<ConfigurationResource> localizer)
        {
